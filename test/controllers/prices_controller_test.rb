...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { name: @price.name, price: @price.price, taxpercentage: @price.taxpercentage, user_id: @price.user_id }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { name: @price.name, price: @price.price, taxpercentage: @price.taxpercentage, user_id: @price.user_id }
    assert_redirected_to price_path(assigns(:price))
  end
